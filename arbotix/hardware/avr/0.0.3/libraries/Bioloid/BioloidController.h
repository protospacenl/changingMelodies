...
class BioloidController
{
  public:
    ...
    bool readPose();                            // read a pose in from the servos  
    ...
    void interpolateSpeedSetup(int time);            // calculate speeds for smooth transition
    void interpolateSpeedStep();                     // move forward one step in current interpolation  
